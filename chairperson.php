                    ...
                    <div class="modal-content">
                        ...
                        <form id="emailForm" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="mb-3" id="loadingContainer">
            ...
            <div class="table-responsive">
                <table id="zero_config" class="table table-striped table-bordered">
                    ...
                    <tbody id="table-body">
                        ...
                        $sn = 1;
                        $sqll1 = "SELECT * FROM indiscipline WHERE permission = 1  ORDER BY regno ASC, remarks ASC";

                        $resultl1 = $db->query($sqll1);

                        $sql2 = "SELECT * FROM indiscipline WHERE permission=0  ORDER BY regno ASC, remarks ASC";
                        $result2 = $db->query($sql2);
                        ?>

                        <?php while ($rowl1 = $resultl1->fetch_assoc()): ?>
                            <tr>
                                <td class='text-center'><?= $sn++ ?></td>
                                <td class='text-center'><?= htmlspecialchars($rowl1["regno"]) ?></td>
                                <td class='text-center'><?= htmlspecialchars($rowl1["dept"]) ?></td>
                                <td class='text-center'><?= date("d-m-Y", strtotime($rowl1["date"])) ?></td>
                                <td class='text-center'><?= htmlspecialchars($rowl1["remarks"]) ?></td>
                            </tr>
                        <?php endwhile; ?>
                        ...
                        <?php while ($row2 = $result2->fetch_assoc()): ?>
                            <tr>
                                <td class='text-center'><?= $sn++ ?></td>
                                <td class='text-center'><?= htmlspecialchars($row2["regno"]) ?></td>
                                <td class='text-center'><?= htmlspecialchars($row2["dept"]) ?></td>
                                <td class='text-center'><?= date("d-m-Y", strtotime($row2["date"])) ?></td>
                                <td class='text-center'><?= htmlspecialchars($row2["remarks"]) ?></td>
                            </tr>
                        <?php endwhile; ?>
